...
gqlg --schemaFilePath ./example/sampleTypeDef.graphql --destDirPath ./example/output --depthLimit 5 --rootQuery Query --enableApollo --enableOriginalQuery --apolloVersion 2
```
